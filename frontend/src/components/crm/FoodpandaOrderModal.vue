              ...
              <div>
                ...
                <div class="flex items-center space-x-1">
                  ...
                  <span class="text-gray-600">{{
                    branchDetails[selectedBranch].rating
                  }}</span>
                </div>
              </div>
              <div>
                ...
                <p class="text-gray-800">
                  {{ branchDetails[selectedBranch].reviews }}
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="flex items-start space-x-2 sm:space-x-3">
              ...
              <div class="text-xs sm:text-sm text-blue-800">
                ...
                <p>
                  ...
                  with real-time tracking, exclusive deals, and faster checkout!
                </p>
              </div>
            </div>
          </div>
...
<script setup>
  ...
  const downloadApp = () => {
    ...
    if (/android/i.test(userAgent)) {
      ...
      window.open(
        'https://play.google.com/store/apps/details?id=com.foodpanda.android',
        '_blank'
      );
