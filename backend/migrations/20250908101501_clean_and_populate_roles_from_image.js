...
exports.up = async function (knex) {
  // Clear all existing roles and reset the sequence
  await knex("user_roles").del();

  // Reset the auto-increment sequence (PostgreSQL specific)
  await knex.raw("ALTER SEQUENCE user_roles_role_id_seq RESTART WITH 1");
  ...
  console.log(
    "✅ Successfully cleaned and populated roles from image structure"
  );
};
...
exports.down = async function (knex) {
  ...
  await knex("user_roles").del();
  console.log("🗑️ Removed all roles from image structure");
};
