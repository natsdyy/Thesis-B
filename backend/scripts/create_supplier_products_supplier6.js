...
/**
 * Script to create SupplierProducts for Supplier ID 6 (Cedric Kyle Belisario)
 * This script extracts unique products from purchase order items, excluding Cellphone
 */

// Purchase order items data for Supplier ID 6 (excluding Cellphone)
const purchaseOrderItems = [
  // From PO-1758722084561 (excluding Cellphone)
  // Cellphone excluded as requested

  // From PO-1758261376618
  { item_name: "Bihon", unit: "packs", unit_price: "90.00", supplier_id: 6 },
  {
  ...
  { item_name: "Calamansi", unit: "kg", unit_price: "150.00", supplier_id: 6 },
  { item_name: "Carrot", unit: "kg", unit_price: "140.00", supplier_id: 6 },
  { item_name: "Cabbage", unit: "kg", unit_price: "160.00", supplier_id: 6 },
  { item_name: "Chayote", unit: "kg", unit_price: "100.00", supplier_id: 6 },
  {
    item_name: "Ground pepper",
    unit: "kg",
    unit_price: "60.00",
    supplier_id: 6,
  },
  ...
  // From PO-1758258546632
  { item_name: "Beef", unit: "kg", unit_price: "160.00", supplier_id: 6 },
  { item_name: "Mushroom", unit: "cans", unit_price: "50.00", supplier_id: 6 },
  {
    item_name: "Soy Sauce",
    unit: "liters",
    unit_price: "170.00",
  ...
  { item_name: "Onion", unit: "kg", unit_price: "150.00", supplier_id: 6 },

  // From PO-1758167443716
  { item_name: "Tomato", unit: "kg", unit_price: "50.00", supplier_id: 6 },
  { item_name: "Pipino", unit: "kg", unit_price: "10.00", supplier_id: 6 },

  // From PO-1756625418014
  { item_name: "Rice", unit: "pieces", unit_price: "1250.00", supplier_id: 6 },
  { item_name: "Egg", unit: "cases", unit_price: "200.00", supplier_id: 6 },
];
...
async function createSupplierProductsFromItems() {
  try {
    console.log(
      "🚀 Creating supplier products for Supplier ID 6 (Cedric Kyle Belisario)..."
    );
    console.log("📋 Note: Cellphone items are excluded as requested");
    console.log(
...
if (require.main === module) {
  console.log("🎯 Supplier Product Creator - Supplier ID 6");
  console.log("📋 Creating supplier products for Cedric Kyle Belisario...");
  console.log("🚫 Excluding Cellphone items as requested");
