  ...
  try {
    ...
    for (const employee of employees) {
      ...
      if (leaveRequests.length > 0) {
        console.log(`   ⚠️  Employee is on leave during October - SKIPPING`);
        ...
        employeesOnLeave.add(employee.id);
        continue;
      }
      ...
      // Check for existing attendance records for this employee in October 2025
