...
/**
 * Script to create SupplierProducts for Supplier ID 5 (Charles Alvaran)
 * This script extracts unique products from purchase order items
 */

// Purchase order items data for Supplier ID 5
const purchaseOrderItems = [
  // From PO-1757008963029
  { item_name: "Pencil", unit: "pieces", unit_price: "30.00", supplier_id: 5 },

  // From PO-1756914576461
  { item_name: "Laptop", unit: "pieces", unit_price: "120.00", supplier_id: 5 },

  // From PO-1756705460066
  {
    item_name: "Bond Paper - A4 - ream",
    unit: "pieces",
    unit_price: "200.00",
    supplier_id: 5,
  },
  ...
  { item_name: "Ink", unit: "pieces", unit_price: "200.00", supplier_id: 5 },

  // From PO-1756703202224
  {
    item_name: "Printer",
    unit: "pieces",
    unit_price: "5000.00",
...
async function createSupplierProductsFromItems() {
  try {
    console.log(
      "🚀 Creating supplier products for Supplier ID 5 (Charles Alvaran)..."
    );
    console.log(
...
if (require.main === module) {
  console.log("🎯 Supplier Product Creator - Supplier ID 5");
  console.log("📋 Creating supplier products for Charles Alvaran...");
