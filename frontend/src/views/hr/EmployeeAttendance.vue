  ...
  <div class="employee-attendance">
    ...
    <div class="card mb-6">
      ...
      <div class="card-body">
        ...
        <div
          v-else-if="attendanceStore.todayAttendance"
              ...
              <div class="status-value">
                {{
                  attendanceStore.todayAttendance.time_in
                    ? formatTime(attendanceStore.todayAttendance.time_in)
                    : 'Not recorded'
                }}
              </div>
            </div>
              ...
              <div class="status-value">
                {{
                  attendanceStore.todayAttendance.time_out
                    ? formatTime(attendanceStore.todayAttendance.time_out)
                    : 'Not recorded'
                }}
              </div>
            </div>
      ...
      <div class="card-body">
        <div v-if="!showQRScanner" class="scanner-placeholder">
          ...
          <p class="text-gray-600 mb-4">
            Click "Time In" to start scanning QR code
          </p>
          <button
            @click="showQRScanner = true"
        ...
        <div v-else class="qr-scanner-section">
          ...
          <div class="scanner-actions mt-4">
            <button @click="showQRScanner = false" class="btn btn-outline">
              Cancel
            </button>
          </div>
        </div>
    ...
    <div class="card">
      <div class="card-header">
        ...
        <button @click="fetchMyAttendance" class="btn btn-outline btn-sm">
          Refresh
        </button>
      </div>
