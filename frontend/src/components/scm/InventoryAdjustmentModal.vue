  ...
  <dialog id="inventory_adjustment_modal" class="modal">
    <div class="modal-box max-w-2xl">
      ...
      <form @submit.prevent="handleSubmit">
        ...
        <!-- Current Stock Info -->
        <div v-if="selectedStock" class="alert alert-info mb-6">
          <div class="flex items-center">
            ...
            <div>
              ...
              <p v-if="selectedStock.batch_number" class="text-sm">
                <strong>Batch:</strong> {{ selectedStock.batch_number }}
              </p>
              <p v-if="selectedStock.expiry_date" class="text-sm">
        ...
        <!-- Preview Section -->
        <div v-if="adjustmentPreview" class="alert alert-warning mb-6">
          <div>
...
<script setup>
  ...
  const formatStockOption = (stock) => {
    ...
    return `${qty} ${stock.unit_of_measure}${batch}${expiry}${status}`;
  };
