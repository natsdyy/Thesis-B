      ...
      <div class="card bg-base-100 shadow-xl">
        <div class="card-body">
          ...
          <button
            ...
            class="btn btn-outline font-thin w-full hover:bg-base-200"
          >
            <svg
              class="w-4 h-4 mr-2"
              fill="none"
          ...
          <table class="table table-zebra w-full">
            ...
            <tbody>
              <tr v-for="row in mergedHistory" :key="row.date">
                ...
                <td class="font-mono text-sm">{{ formatTime(row.timeIn) }}</td>
                <td class="font-mono text-sm">{{ formatTime(row.timeOut) }}</td>
