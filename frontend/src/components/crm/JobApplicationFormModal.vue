<template>
  ...
  >
    <div class="min-h-full flex items-start justify-center p-4 pt-26 pb-6">
      <div
        class="bg-white rounded-2xl w-full max-w-4xl max-h-[calc(100vh-7rem)] min-h-0 flex flex-col shadow-2xl"
      >
        <!-- Modal Header -->
        <div
            ...
            <div>
              ...
              <div>
                <p class="text-green-100">
                  {{
                    selectedPosition
                      ? `Applying for: ${selectedPosition.position_title}`
                      : 'Submit your application'
                  }}
                </p>
                <p
                  v-if="selectedPosition?.branch_name"
                  class="text-green-200 text-sm mt-1 flex items-center"
                >
                  <font-awesome-icon
        ...
        <div
          v-if="showError"
          class="bg-red-50 border-l-4 border-red-400 p-4 mx-6 mt-4 rounded flex-shrink-0"
        >
          ...
          <form @submit.prevent="submitApplication" class="space-y-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p class="text-xs text-gray-500 mt-1">
                    Format: 09XX XXX XXXX (must start with 09)
                  </p>
                </div>
            ...
            <div class="bg-gray-50 rounded-lg p-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div
                  v-if="
                    props.selectedPosition && props.selectedPosition.branch_name
                  "
                >
                  <label class="block text-sm font-medium text-gray-700 mb-2">
                    Branch
                  ...
                  <input
                    type="text"
                    :value="props.selectedPosition.branch_name"
                    readonly
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-100 text-gray-700"
                  />
                </div>
            ...
            <div class="bg-gray-50 rounded-lg p-6">
              ...
              <div>
                ...
                <p class="text-xs text-gray-500 mt-2">
                  Please upload your resume or CV. Accepted formats: PDF, DOC,
                  DOCX. Max file size: 5MB.
                </p>
              </div>
            </div>
            ...
            <div class="bg-gray-50 rounded-lg p-6">
              ...
              <div class="flex justify-center min-h-[78px] items-center">
                <div
                  v-if="!recaptchaLoaded && !captchaError"
              ...
              <p class="text-xs text-gray-500 mt-2 text-center">
                Please complete the verification to confirm you're not a robot
              </p>
              <p
                v-if="captchaError"
              ...
              <!-- Retry reCAPTCHA Button -->
              <div v-if="captchaError" class="flex justify-center mt-2">
                <button
                  type="button"
                  @click="handleRecaptchaRetry"
                  class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg font-medium text-sm transition-all duration-300 shadow border-none cursor-pointer"
    ...
    >
      ...
      >
        ...
        <p class="text-gray-600 mb-6">
          ...
          <strong>{{ selectedPosition?.position_title }}</strong
...
<script setup>
  ...
  const loadRecaptchaScript = () => {
    return new Promise((resolve, reject) => {
      ...
      script.onload = () => {
        ...
        const checkGrecaptcha = setInterval(() => {
          ...
          if (window.grecaptcha && window.grecaptcha.render) {
            ...
            clearInterval(checkGrecaptcha);
            console.warn(
              'reCAPTCHA object not immediately available after script load, but script loaded'
            );
      ...
      script.onerror = (error) => {
        ...
        captchaError.value =
          'Failed to load security verification. Please check your internet connection and try again.';
  ...
  const renderRecaptcha = async () => {
    try {
      ...
      if (!grecaptchaAvailable) {
        ...
        captchaError.value =
          'reCAPTCHA API not loaded. Please check your internet connection and refresh the page.';
        return;
      }
      ...
      if (!window.grecaptcha.render) {
        ...
        captchaError.value =
          'reCAPTCHA render function not available. Please refresh the page.';
        return;
      }
      ...
      try {
        ...
        console.log(
          'reCAPTCHA widget rendered successfully, ID:',
  ...
  const submitApplication = async () => {
    try {
      ...
      if (error.message.includes('Failed to fetch')) {
        ...
        errorMsg +=
          'Invalid data format. Please check your salary and experience values.';
      } else {
  ...
  onMounted(() => {
    ...
    loadRecaptchaScript()
      ...
      .catch((err) => {
        console.warn(
          'Preloading reCAPTCHA failed (will retry when modal opens):',
          err
        );
      });
  });

  // Add method for retrying recaptcha
  const handleRecaptchaRetry = async () => {
    captchaError.value = '';
    recaptchaToken.value = null;
    await renderRecaptcha();
  };
